...

{
    ...
    $revalue = '';
    $basefield ='a.id,a.aid,a.webid,a.title,a.summary,a.seotitle,a.shownum,a.content,a.addtime,a.webid,a.attrid,a.litpic as litpic,a.kindlist,a.author';
    ...
    {
        $sql = "select *,max(pltime) as ordertime from (select a.*,b.id as plid,b.memberid,b.content as plcontent,b.addtime as pltime from #@__article a inner join #@__comment b on (a.ishidden = 0 and a.id = b.articleid and b.typeid=4 and b.isshow=1)) as t group by t.id order by ordertime desc limit {$limit},{$row}";
    }

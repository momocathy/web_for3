          ...
          <div class="manage-nr">
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="product-add-div" data-id="material">
                      ...
                      <div id="material-1">{php Common::getEditor('material',$info['material'],700,600);}</div>
                      <div id="material-2" style="display: none">{php Common::getEditor('material2',$info['material2'],700,600);}</div>
                      <div id="material-3" style="display: none">{php Common::getEditor('material3',$info['material3'],700,600);}</div>
                      <div id="material-4" style="display: none">{php Common::getEditor('material4',$info['material4'],700,600);}</div>
                      <div id="material-5" style="display: none">{php Common::getEditor('material5',$info['material5'],700,600);}</div>

...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            var url=SITEURL+"supplier/add/parentkey/member/itemid/2";
        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        var id=record.get('id');
                        var is_selected=value==1?" selected='selected' ":'';

                        var html ="<select onchange=\"updateField(this,"+id+",'',0,'select')\" class='row-edit-select'>";
                            html+="<option value='0'>未认证</option>";
                            html+="<option value='1'"+is_selected+">已认证</option>";
                            html+="</select>";
...
function modify(id)
{
    var url=SITEURL+"supplier/edit/parentkey/member/itemid/2/id/"+id;

                              ...
                              <div class="price_sub">
                                  <div>
                                      <table class="price_tb">
                                          ...
                                          <tr>
                                              <td class="tit">适用人群：</td><td class="prop-group"><input type="checkbox" name="propgroup[]" value="2" id="adultgroup" checked="checked"/>成人&nbsp;&nbsp;&nbsp;<input type="checkbox" name="propgroup[]" value="1" id="childgroup">儿童&nbsp;&nbsp;&nbsp;<input type="checkbox" name="propgroup[]" value="3" id="oldgroup">老人
                                              </td>
                                          </tr>
                                          <tr>

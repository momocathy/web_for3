        ...
        <div class="sms-base sms-single">
            ...
            <div class="b-con">
                <div class="tool-cs">
                    ...
                    <span><input type="radio" name="cfg_pc_version" value="{$pcVersion['id']}" {if $config['cfg_pc_version']==$pcVersion['id']} checked="checked" {/if}/><label>{$pcVersion['name']}</label></span>&nbsp;&nbsp;
                    {/loop}
                </div>
            </div>
        </div>
        <div class="sms-base sms-single">
            ...
            <div class="b-con">
                <div class="tool-cs">
                    ...
                    <span><input type="radio" name="cfg_mobile_version" value="{$mobileVersion['id']}" {if $config['cfg_mobile_version']==$mobileVersion['id']} checked="checked" {/if}/><label>{$mobileVersion['name']}</label></span>&nbsp;&nbsp;
                    {/loop}
                </div>
            </div>
        </div>
